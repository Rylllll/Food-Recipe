export { createScalarToken, resolveAsScalar, setScalarValue } from 'yaml/dist/parse/cst-scalar.js';
export { stringify } from 'yaml/dist/parse/cst-stringify.js';
export { visit, Visitor, VisitPath } from 'yaml/dist/parse/cst-visit.js';
